        ...
        <nav className={`sticky top-0 w-full z-50 transition-all duration-300 ${isScrolled ? 'bg-slate-900/95 -backdrop-blur-[2px] shadow-lg' : 'bg-slate-900'}`}>
            <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8">
                <div className="relative flex items-center justify-between h-16">
                    {/* Logo and Address - Improved Responsiveness */}
                    <div className="flex items-center space-x-2 sm:space-x-4">
                        <NavLink
                            to="/products"
                            className="relative mix-blend-plus-lighter overflow-hidden z-10 flex-shrink-0"
                        >
                            <div className="w-24 sm:w-32 h-12 sm:h-16 bg-gradient-to-r rounded-lg flex items-center justify-center shadow-lg transform hover:scale-110 transition-transform duration-200">
                                <img src={logo} alt="Rebook Logo" className="max-w-full max-h-full" />
                            </div>
                        </NavLink>
                        
                        {/* Address Display - Hidden on very small screens */}
                        <div className="">
                    ...
                    {/* Desktop Search and Auth - Adjusted for Better Responsiveness */}
                    <div className="hidden lg:flex items-center space-x-3 xl:space-x-4">
                        <form onSubmit={handleSearchSubmit} className="relative">
                            <input
                                ...
                                className="w-48 xl:w-64 px-10 py-2 pl-10 text-sm outline-none text-gray-200 bg-slate-800/50 rounded-lg border-2 border-slate-700 focus:outline-none focus:border-yellow-500 focus:ring-1 focus:ring-yellow-500 transition-all duration-200 placeholder-gray-400"
                            />
                    ...
                    {/* Mobile Controls - Adjusted Spacing */}
                ...
                {/* Mobile Search Bar - Improved Responsiveness */}
